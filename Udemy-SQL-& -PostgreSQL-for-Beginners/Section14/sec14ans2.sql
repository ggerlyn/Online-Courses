...
-- ALTER TABLE order_details ALTER COLUMN delivery_date TYPE TIMESTAMP;
-- ALTER TABLE order_details DROP COLUMN delivery_date;
-- ALTER TABLE order_details ADD COLUMN delivery_date TIMESTAMP NOT NULL;
...
SELECT product_name AS "Product", COUNT(product_name) as "Order count", SUM(order_amount) as "Total sales" FROM order_details
GROUP BY "Product"
ORDER BY "Product";

-- Solutions for section 14 coding exercise 2
